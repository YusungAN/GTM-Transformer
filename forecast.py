...
def run(args):
    ...
    test_loader = ZeroShotDataset(test_df[cut-1280:], Path(args.data_folder + '/images'), gtrends, args.trend_len, reviews_df, False).get_loader(batch_size=1, train=False)
