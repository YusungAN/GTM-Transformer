...
def run(args):
    ...
    train_loader = ZeroShotDataset(train_df[:20000], Path(args.data_folder + '/images'), gtrends[:20000], cat_dict, col_dict,
                                   fab_dict, args.trend_len).get_loader(batch_size=args.batch_size, train=True)
    test_loader = ZeroShotDataset(test_df[:20000], Path(args.data_folder + '/images'), gtrends[:20000], cat_dict, col_dict,
