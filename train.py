...
def run(args):
    ...
    test_loader = ZeroShotDataset(train_df[24017:28738], Path(args.data_folder + '/images'), gtrends, args.trend_len, reviews_df, False).get_loader(batch_size=args.batch_size, train=True)
